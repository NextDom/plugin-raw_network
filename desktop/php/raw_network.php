...
$plugin = plugin::byId('raw_network');
sendVarToJS('eqType', $plugin->getId());
$eqLogics = eqLogic::byType($plugin->getId());

include_file('desktop', 'raw_network', 'css', 'raw_network');
?>
    <!-- Sidebar navigator -->
        ...
        <div class="col-lg-2 col-md-3 col-sm-4">
            <div class="bs-sidebar">
                <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
                    <a class="btn btn-default eqLogicAction" data-action="add"><i class="fa fa-plus-circle"></i> {{add-equipment}}</a>
...
<?php
include_file('desktop', 'raw_network', 'js', 'raw_network');
